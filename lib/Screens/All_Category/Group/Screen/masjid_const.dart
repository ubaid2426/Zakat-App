...
// void main() {
//   runApp(const MasjidConst());
// }

// class MasjidConst extends StatelessWidget {
//   const MasjidConst({super.key});
...
class MasjidConst extends StatefulWidget {
  const MasjidConst({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _MasjidConstState createState() => _MasjidConstState();
}

class _MasjidConstState extends State<MasjidConst> {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => Data(
          ...
          selectcategory: 'masjidConst',
          screentitle: 'Masjid Construction',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Masjid Consttruction"),
      ),
      body: Column(
        children: [
