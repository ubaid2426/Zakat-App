...
// void main() {
//   runApp(const MasjidMaintenance());
// }

// class MasjidMaintenance extends StatelessWidget {
//   const MasjidMaintenance({super.key});
...
class MasjidMaintenance extends StatefulWidget {
  const MasjidMaintenance({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _MasjidMaintenanceState createState() => _MasjidMaintenanceState();
}

class _MasjidMaintenanceState extends State<MasjidMaintenance> {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => Data(
          ...
          selectcategory: 'masjidmaintenance',
          screentitle: 'Masjid Maintainance',
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            const Text("Masjid Maintainance"),
            IconButton(
