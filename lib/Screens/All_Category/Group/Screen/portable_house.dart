...
// void main() {
//   runApp(const PortableHouse());
// }

// class PortableHouse extends StatelessWidget {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => Data(
          ...
          selectcategory: 'portablehouse',
          screentitle: 'Portable House',
