...
import 'package:sadqahzakat/components/donate_special.dart';
...
class TreeDonation extends StatefulWidget {
  const TreeDonation({super.key});

  @override
  _TreeDonationState createState() => _TreeDonationState();
}

class _TreeDonationState extends State<TreeDonation> {
  ...
  Future<void> _fetchSortedClothes() async {
    ...
    final donations = await DonationService().fetchDonations(
        sort: sortvalue, filter: filterValue, category: "	treedonation", selectCategory:"individual");
