...
class _DataState extends State<Data> {
  ...
  void initState() {
    super.initState();
    // Accessing widget values inside initState
  ...
  Widget buildDonationSection() {
    ...
    if (progress >= 1.0) {
      return Padding(
        ...
        child:CustomButton(title: "Donation Complete", icon: FontAwesomeIcons.checkDouble)
        // ElevatedButton(
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: CheckboxListTile(
        ...
        title: const Text('This Donation is Zakat'),
        controlAffinity:
            ListTileControlAffinity.leading, // Checkbox before title
      ),
    );
  }
}
